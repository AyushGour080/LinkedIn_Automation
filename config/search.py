...
search_terms = ["Software Engineer", "Software Developer", "Python Developer", "Java Developer", "Backend Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer" ]
...
switch_number = 1                # Only numbers greater than 0... Don't put in quotes
...
location = ["Noida","Gurugram","Bangalore","Hydrabad","Pune","Mumbai"]                      # (dynamic multiple select)
